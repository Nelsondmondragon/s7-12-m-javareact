...
public class CustomerController {
    ...
    public ResponseEntity<CustomerDetailsDto> getCustomerById(@Parameter(description = "Identificador unico del cliente.")@PathVariable Long id) {
    ...
    public ResponseEntity<CustomerDetailsDto> deleteCustomer(@Parameter(description = "Identificador unico del cliente.") @PathVariable Long id) {
