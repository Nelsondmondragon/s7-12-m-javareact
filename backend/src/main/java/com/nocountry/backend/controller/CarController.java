...
public class CarController {
    ...
    public ResponseEntity<List<CarDto>> getCarsByFilters(
        ...
        var cars = carService.findCarsByFilters(model, make, year, air, gps, passengers, idLocation,
    ...
    @PutMapping(value = "/{carId}/image", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
