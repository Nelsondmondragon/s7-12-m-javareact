...
public class RestApiErrorHandler {
    ...
    public ResponseEntity<Error> handleRegisterException(HttpServletRequest request,
        ...
        Error error = ErrorUtils
                .createError(
                        String.format("%s %s", ErrorCode.USER_REGISTER.getErrMsgKey(), ex.getMessage()),
                        ex.getErrorCode(),
    ...
    public ResponseEntity<Error> handleGenericNotFoundException(HttpServletRequest request,
        ...
        Error error = ErrorUtils
                .createError(
                        String.format("%s %s", ErrorCode.ENTITY_NOT_FOUND.getErrMsgKey(), ex.getMessage()),
                        ex.getErrorCode(),
    ...
    public ResponseEntity<Error> handleCarNotFoundException(HttpServletRequest request,
        ...
        Error error = ErrorUtils
                .createError(
                        String.format("%s %s", ErrorCode.CAR_NOT_FOUND.getErrMsgKey(), ex.getMessage()),
                        ex.getErrorCode(),
                        HttpStatus.NOT_FOUND.value()).setUrl(request.getRequestURL().toString())
                .setReqMethod(request.getMethod()).setTimestamp(Instant.now());
        return new ResponseEntity<>(error, HttpStatus.NOT_FOUND);
