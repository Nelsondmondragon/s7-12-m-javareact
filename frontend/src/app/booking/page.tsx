        ...
        <div>
          <div className="flex">
            {categories.map((cat) => (
              <div
                key={cat.id}
                className={`relative flex items-start justify-between rounded-xl border border-gray-100 p-4 shadow-xl sm:p-6 lg:p-8 hover:border-blue-700 ${category=== cat.name && 'border-red-700'}`}
